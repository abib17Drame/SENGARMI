...
const NotreApplication = () => {
  const fonctionnalites = [
    ...
    },
    {
      ...
      description: "Échangez en temps réel avec votre équipe de nettoyage."
    },
    {
      icone: CreditCard,
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <section className="text-center mb-20 animate-fade-in">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Gérez tous vos services de ménage depuis votre smartphone. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a 
                href="#" 
                className="inline-flex items-center justify-center h-14 px-6 bg-black text-white rounded-lg hover:bg-black/90 transition-colors"
              >
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Une application complète pour simplifier la gestion de vos services
            </p>
          </div>
        ...
        <section className="text-center bg-primary rounded-lg p-8 lg:p-12 text-primary-foreground">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Téléchargez l'application Sengarmi dès maintenant et découvrez 
            une nouvelle façon de gérer vos services de ménage.
          </p>
